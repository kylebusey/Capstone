...
from .views import UserCreateView, FacultyCreateView, GetCSRFToken, LoginView, LogoutView, DisplayUserAccounts, DisplayUserInformation, DisplayCourses, CourseRegister, CreateCourse, CourseDrop, DisplayRegisteredCourses
